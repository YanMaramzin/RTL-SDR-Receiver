...
std::vector<double> FilterLowPass::filtration(std::vector<double> &in, double inpuSampleRate, double passFreq, double suppressFreq)
{
    std::vector<double> filtSig(in.size());
    filtSig.reserve(in.size());
